...
class Day4Tests: XCTestCase, FileReader {
    ...
    func testGuardIDAfterManyLines() {
        let input = [
    ...
    func testAllGuardsShiftAllNights() {
        populateSutWithTestData()
        let expected = [
            ".....####################.....#########################.....",
            "........................#####...............................",
            "........................................##########..........",
    ...
    func testWhatGuardIsTheMostFrequentSleeperOnWhatMinute() {
        populateSutWithTestData()
        let result = sut.guardMostFrequentSleeperOnAnyMinute()
        print(result.minuteSpentMostAsleep)
        XCTAssertEqual(result.ID, 99)
    }

    private func populateSutWithTestData() {
        let input = [
            "[1518-11-01 00:00] Guard #10 begins shift",
            "[1518-11-01 00:05] falls asleep",
            "[1518-11-01 00:25] wakes up",
